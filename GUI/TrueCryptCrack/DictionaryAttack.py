...
class DictionAttack():
    ...
    def __init__(self):
        ...
        self.container = '"C:\Users\Lewis Collins\Desktop\TestTrueCrypt.txt"'
        self.tc_prog = 'G:\TrueCrypt\TrueCrypt.exe'
        self.tc_mount_letter = "Q"

        self.mount_command_params = "/auto /quit /silent /volume %s /l %s /history n /password " % (self.container, self.tc_mount_letter)
        ...
        self.password_file = 'C:/Users/Lewis Collins/FinalProjectV3.0/GUI/PasswordGenerator/PWNumCombo.txt'
